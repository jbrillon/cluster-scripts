...
RUN_ON_TMPDIR=false                       ## Set as true for fast write speeds (default) -- WARNING: Output files will only be copied to your output file directory once mpirun has completed. 
