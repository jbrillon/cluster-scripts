...
#SBATCH --job-name=viscous_LES_smagorinsky_cPlus_entropy_conserving_flux_with_l2roe_dissipation_dofs048_p5
...
NUM_PROCS="64"                           ## WARNING: must correspond to nodes*(ntasks-per-node) above
