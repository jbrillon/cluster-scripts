...
#SBATCH --job-name=viscous_LES_smagorinsky_cPlus_entropy_conserving_flux_with_l2roe_dissipation_dofs096_p5
...
PARAMETERS_FILE="input.prm" ## <-- Enter .prm filename here
PHiLiP_DIMENSIONS="3"                    ## WARNING: must correspond to the DIM in the .prm file
NUM_PROCS="512"                           ## WARNING: must correspond to nodes*(ntasks-per-node) above
